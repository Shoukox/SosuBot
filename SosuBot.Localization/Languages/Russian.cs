...
public sealed class Russian : ILocalization
{
    ...
    public string command_help =>
        ...
        $"/calc [x100] [x50] [xMiss] [mods] - калькулятор пп выбранной стд карты с этой статистикой.\n" +
        $"/calcmania [x300] [x200] [x100] [x50] [xMiss] [mods] - калькулятор пп выбранной мании карты с этой статистикой.\n" +
        $"\n" +
    ...
    public string command_last => Shared.CommandLast + " пройдено";
    ...
    public string score_replayAvailable => "Чтобы отрендерить этот скор, отправьте /render в ответ на это сообщение.";
