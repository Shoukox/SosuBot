...
public struct Russian : ILocalization
{
    ...
    public string command_help =>
        ...
        $"/exclude [nickname] - исключить юзера из списка топ10 игроков в чате.\n" +
        $"/include [nickname] - вернуть исключенного юзера в список топ10 игроков в чате.\n" +
        $"/chatstats [gamemode] - топ10 игроков в чате.\n" +
        $"/ranking [RU/UZ/country_code] - топ20 игроков для данной страны. Если страна не указана, используется global ранкинг.\n" +
        $"/daily_stats - эксклюзивно для Узбекистана. Ежедневная статистика по всем скорам от всех игроков в стране.\n" +
        $"/render - в разработке. Рендер реплеев\n" +
        $"\n" +
