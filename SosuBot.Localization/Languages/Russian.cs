...
public struct Russian : ILocalization
{
    ...
    public string command_help =>
        ...
        $"/render - рендер реплеев. В ответ на скор из бота, либо на реплей файл.\n" +
        $"/settings - настройки рендера реплеев.\n" +
        $"/setskin - выбрать свой скин. В ответ на файл скина до 20мб.\n" +
        $"\n" +
        ...
        $"\n" +
        $"По вопросам и предложениям писать @Shoukkoo";
