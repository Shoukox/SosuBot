            ...
            modelBuilder.Entity("DailyStatisticsUserEntity", b =>
                {
                    ...
                    b.ToTable("DailyStatisticsUserEntity", (string)null);
                });
            ...
            modelBuilder.Entity("SosuBot.Database.Models.OsuUser", b =>
                {
                    ...
                    b.ToTable("OsuUsers", (string)null);
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            OsuUserId = 15319810L,
                            OsuUsername = "Shoukko",
                            RenderSettings = "{\"Encoder\":\"h264_nvenc\",\"SkinName\":\"default\",\"GeneralVolume\":0.5,\"MusicVolume\":0.5,\"SampleVolume\":0.5,\"HitErrorMeter\":false,\"AimErrorMeter\":false,\"HPBar\":true,\"ShowPP\":false,\"HitCounter\":false,\"IgnoreFailsInReplays\":false,\"Video\":false,\"Storyboard\":false}",
                            StdPPValue = 0.0,
                            TaikoPPValue = 0.0
                        });
                });
            ...
            modelBuilder.Entity("SosuBot.Database.Models.ScoreEntity", b =>
                {
                    ...
                    b.ToTable("ScoreEntity", (string)null);
                });
